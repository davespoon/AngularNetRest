            ...
            if (!context.BoardGames.Any())
            {
                ...
                (
                    new BoardGame
                    {
                        ...
                        Price = 990.00M,
                        ImageThumbnailUri = "~/images/Thumbnails/Pandemic.jpg",
                        ImageFullUri = "~/images/Full/Pandemic.jpg",
                        LongDescription =
                    ...
                    new BoardGame
                    {
                        ...
                        Price = 1500.00M,
                        ImageThumbnailUri = "~/images/Thumbnails/MiceAndMystics.jpg",
                        ImageFullUri = "~/images/Full/MiceAndMystics.jpg",
                        LongDescription =
                    ...
                    new BoardGame
                    {
                        ...
                        Price = 1900.00M,
                        ImageThumbnailUri = "~/images/Thumbnails/Civilization.jpg",
                        ImageFullUri = "~/images/Full/Civilization.jpg",
                        LongDescription =
                    ...
                    new BoardGame
                    {
                        ...
                        Price = 400.00M,
                        ImageThumbnailUri = "~/images/Thumbnails/Carcasone.jpg",
                        ImageFullUri = "~/images/Full/Carcasone.jpg",
                        LongDescription =
                    ...
                    new BoardGame
                    {
                        ...
                        Price = 800.00M,
                        ImageThumbnailUri = "~/images/Thumbnails/ArkhamHorror.jpg",
                        ImageFullUri = "~/images/Full/ArkhamHorror.jpg",
                        LongDescription =
                    ...
                    new BoardGame
                    {
                        ...
                        Price = 500.00M,
                        ImageThumbnailUri = "~/images/Thumbnails/CodenamesDuet.jpg",
                        ImageFullUri = "~/images/Full/CodenamesDuet.jpg",
                        LongDescription =
